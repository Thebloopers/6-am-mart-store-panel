...
const Addnew = () => {
  ...
  const {
    ...
    ["subCategories", { mainCategory, cookies }],
    () => getAllSubCategories(mainCategory, cookies),
    {
  ...
  const {
    ...
    data: data3,
    refetch: refetch3,
  } = useQuery(["unit", { cookies }], () => getUnits(cookies));
  const {
    isError: isError4,
    isSuccess: isSuccess4,
    data: data4,
    refetch: refetch4,
  } = useQuery(["attribute", { cookies }], () => getAttributes(cookies));
  ...
  const productMutation = useMutation(addNewItem, {
    onSuccess: (data) => {
      console.log(data);
      setIsLoading(false);
      if (data.success === true) {
    ...
    <div className="relative">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-10 shadow-lg rounded-lg ">
          <h1 className="font-bold text-gray-700 border-b p-3">
            <CiDollar className="inline-block text-xl text-gray-700 " />
            Item Details
          </h1>
          ...
          <div className="flex justify-start gap-x-2 items-center flex-wrap mt-4 px-2 py-5">
            <label className="form-control w-full max-w-[300px]">
              ...
              <CustomDropdown
                options={data1?.category?.map((item) => {
                  return item;
                })}
        ...
        <div className="mt-10 shadow-lg rounded-lg ">
          ...
          <div className="flex justify-start gap-x-2 items-center flex-wrap mt-4 px-2 py-5">
            ...
            <label className="form-control w-full max-w-[300px]">
              ...
              <CustomDropdown
                options={[{ name: "Percent" }, { name: "Amount" }]}
        ...
        <div className="my-10 shadow-lg p-5">
          <div className="border py-3 mt-5 shadow-lg rounded-lg">
            ...
            <div className="px-3 w-full mt-4">
              <input
                ...
                name="tags"
                className="p-3 border mt-3 w-full focus:outline-sky-200"
              />
            </div>
          </div>
          ...
          <div className="flex gap-4 justify-end mt-5 px-4 ">
            ...
            <button
              type="submit"
              className="btn font-bold bg-sky-600 text-white"
