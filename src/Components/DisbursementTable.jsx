            ...
            <div className="md:flex items-center mb-4">
                ...
                <form className="ml-auto flex items-center">
                    <input
                        ...
                        type="search"
                        name="search"
                        className="form-input border border-gray-300 rounded-l-lg px-10 md:px-4 py-3"
            ...
            <table className="table-auto min-w-full border-collapse border border-gray-200">
                ...
                <tbody>
                    ...
                    {tableData.map((data, index) => (
                        ...
                        <div className="flex py-8 items-center justify-center top-[80%] md:top-[55%] left-1/2 -translate-x-1/2 -translate-y-1/2 absolute" key={index}>/
                            <div>

                                <img className="md:h-40 h-28" src={data.img} alt="" />
